    ...
    switch (tag) {
        ...
        case 6:
        {
            ...
            if ([text isEqualToString:[array2 firstObject]]) {
                ...
                UIImageView *myImage = [qrcode generateQuickResponseCodeWithFrame:rect_target dataString:@"https://github.com/VictorZhang2014"];
                ...
                UIImageView *myImage = [qrcode generateQuickResponseCodeWithFrame:rect_target dataString:@"https://github.com/VictorZhang2014" centerImage:center needShadow:YES];
                ...
                UIImage *center = [UIImage imageNamed:@"Victor.jpg"];
                UIImageView *myImage = [qrcode generateQuickResponseCodeWithFrame:rect_target dataString:@"https://github.com/VictorZhang2014" centerImage:center];
